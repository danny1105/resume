...
\begin{itemize}
  \item\indent\small{\textbf{User Management System}	\hfill	\small{\textit{(August'18)}}
  \end{itemize}
  
\justify\indent
A User Management using Redis and Express where you can search a user through UserID, Add a user, Delete a user.
